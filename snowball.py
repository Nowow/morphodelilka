...
#        print(type(rlist))
    ...
    def gtprst(self):
        prst = ('в', 'во', 'взо', 'вы', 'до', 'за', 'из', 'изо', 'на', 'над',
                ...
                'долго', 'ре', 'много', 'само', 'ино')
        
        return(prst)
    
    def gtart(self):
        art = ('куча', 'умека', 'полутора', 'нота', 'пента', 'ра', 'куда', 'гна', 
    ...
    def gtpost(self):
        postfix = ('ъ', 'а', 'я', 'о', 'е', 'ь', 'и', 'ы', 'а', 'ая', 'яя', 'ое', 'ее', 'ый', 'ать', 
               ...
               'им', 'ими', 'ит', 'ите', 'их', 'ишь', 'ию', 'ыми', 'м', 'ми', 'мя', 'о', 'ов', 'ого', 'ость',
    ...
    def gtsfx(self):
        ...
        mysfx = ('ятин', 'ёшк', 'атур', 'от', 'ева', 'арх', 'ельник', 'я', 'ийск', 
                 ...
                 'честв', 'унок', 'енник', 'пис', 'ах', 'юда', 'ани', 'инец', 
